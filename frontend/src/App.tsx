    ...
    <div className="min-h-screen flex flex-col bg-[#0C0518] text-gray-100 font-['Inter',sans-serif] tracking-tight antialiased">
      ...
      <main className="flex-1 relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
          {/* Opacity lowered for dark mode visibility */}
          <SignatureGlobe opacity={0.25} rightOffset="55%" />
        </div>
        <div className="relative" style={{ zIndex: 1 }}>
          <Routes>
            {/* The Main Web3 Dashboard is now your Home Page */}
            <Route path="/"            element={<AppPortal />} />
            
            {/* Your Layer Overview is preserved here */}
            <Route path="/sandbox"     element={<LayerOverview layers={LAYERS} />} />
